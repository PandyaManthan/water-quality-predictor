...
POLLUTION_MODEL_ID = "1WiyY44fwVinBiTSToHLRIBTpXZNyG026"  # Replace with your file ID
MODEL_COLS_ID = "1kHWiR6aXIKHUvaN8Ll8Y7H4XROqh6wOL"  # Replace with your file ID

download_from_google_drive(POLLUTION_MODEL_ID, "pollution_model.pkl")
download_from_google_drive(MODEL_COLS_ID, "model_columns (1).pkl")
